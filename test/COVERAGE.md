...
|---|---|---:|
| `unit (cli)` | `test/unit/cli/` | 2704 (+2 xfailed) |
| `unit (box)` | `test/unit/box/` | 3152 |
...
### Local Unit Tests (`test/unit/` -- 247 files)

#### Box Unit Tests (`test/unit/box/` -- 130 files)

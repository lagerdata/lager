...
This guide walks you through a complete test workflow, in Python or in Rust. It starts at connectivity and ends at an automated test. By the end, you have used the CLI interactively and written your first Lager test script.

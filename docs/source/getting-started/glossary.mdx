...
Any x86-64 machine that runs Ubuntu 22.04 or newer, such as a compact mini PC. It sits on your bench, wired to your instruments and DUT. It runs the Lager container (Flask and SocketIO), which exposes HTTP and WebSocket APIs for hardware control. See [Setting Up a Lager Box](/source/getting-started/setting-up-a-lager-box).

...
Any x86-64 machine running Ubuntu 22.04 or newer (for example, a compact mini PC) that sits on your bench, physically connected to your instruments and DUT. It runs the Lager container (Flask + SocketIO) which exposes HTTP and WebSocket APIs for hardware control. See [Setting Up a Lager Box](/source/getting-started/setting-up-a-lager-box).

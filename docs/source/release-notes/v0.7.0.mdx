...
> Historical note: the control-plane items in this release were part of a migration stage before Stout install/bootstrap was separated from open-source Lager.

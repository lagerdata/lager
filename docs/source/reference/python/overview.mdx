...
| `NetType.GPIO` | Digital I/O | LabJack T7, LabJack U3, MCC USB-202 |
| `NetType.ADC` | Analog-to-digital converter | LabJack T7, LabJack U3, MCC USB-202 |
| `NetType.DAC` | Digital-to-analog converter | LabJack T7, LabJack U3, MCC USB-202 |
...
| `NetType.Debug` | Debug probe | J-Link, OpenOCD-supported probes |
| `NetType.Arm` | Robotic arm | Rotrics Dexarm |
| `NetType.Usb` | USB port control | Acroname, YKUSH, Plugable |
| `NetType.Wifi` | WiFi module | Lager Box WiFi |
| `NetType.Actuate` | Actuator control | Dexarm actuator |
| `NetType.SPI` | SPI bus communication | Aardvark, FT232H, LabJack T7, LabJack U3 |
| `NetType.I2C` | I2C bus communication | Aardvark, FT232H, LabJack T7, LabJack U3 |

...
- `Dexarm` defines approximate workspace bounds: X -300 to 300 mm, Y 170 to 360 mm, Z -140 to 100 mm. The `lager arm` CLI refuses a target outside them. The Python API does not check them before a move.

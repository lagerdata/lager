...
`purpose`, `notes` or `tags`, agents see the override value, not the value saved on
the net. The TUI and `lager nets describe` give no warning about this. Remove the field
from the override before you set it on the net.
</Warning>

...
This command scans your Tailscale network for devices with names 5-8 characters long (typical Lager Box naming convention) and automatically adds them as boxes with uppercase names.

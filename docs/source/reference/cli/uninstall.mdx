...
other file under `/etc/sudoers.d/`, so grants you or your management platform
added in a separate file there are left alone — both by uninstall and by the
installs and updates that regenerate Lager's own files.
</Note>

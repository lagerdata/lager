...
Lager Box. Use it to push a locally built package onto a box, without publishing
it to an index first. It suits an iteration loop on a box-side library or driver.

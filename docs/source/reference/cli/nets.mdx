...
```bash
lager nets add <name> supply 1 'serial://067b:23a3/serial/00000006'
```
...
The cable is offered as a generic UART device again. Saved nets still pointing
at the old `serial://` address stop working — delete them with `lager nets delete`.
...
|----------|-------------|---------------------|
| `supply` | Power supply output | Rigol DP800, Rigol DP711 (via [`assign`](#assign)), Keithley 2200/2280, Keysight E36200 |
